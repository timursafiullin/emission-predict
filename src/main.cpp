...
//     NeuralNetwork::FFNN<std::function<long double(long double)> CO2{structure, l};
//     NeuralNetwork::FFNN<std::function<long double(long double)> NOX{structure, l};
//     NeuralNetwork::FFNN<std::function<long double(long double)> PM{structure, l};
//     NeuralNetwork::FFNN<std::function<long double(long double)> VOC{structure, l};
//     NeuralNetwork::FFNN<std::function<long double(long double)> SO2{structure, l};
